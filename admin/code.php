...
if (isset($_POST['add_category_btn'])) {
    ...
    if ($cate_query_run) {
        ...
        redirect("add-category.php", "Uh-oh! Something Went Wrong!");
    }
    ...
    if ($update_query_run) {
        ...
        redirect("edit-category.php?id=$category_id", "Uh-oh! Something Went Wrong!");
    }
    ...
    if ($delete_query) {
        ...
        // redirect("category.php", "Uh-oh! Something Went Wrong!");
        echo 500;
    }
    ...
    if ($name != "" && $slug != "" && $small_description != "" && $description != "" && $original_price != "" && $selling_price != "" && $qty != "") {
        ...
        if ($product_query_run) {
            ...
            redirect("add-product.php", "Uh-oh! Something Went Wrong!");
        }
    } else {
    ...
    if ($update_product_query_run) {
        ...
        redirect("edit-product.php?id=$product_id", "Uh-oh! Something Went Wrong!");
    }
    ...
    if ($delete_query) {
        ...
        // redirect("products.php", "Uh-oh! Something Went Wrong!");
        echo 500;
    }
